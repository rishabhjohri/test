-- NOTE: No ALTER TABLE privilege required.
-- NOTICE fields remain VARCHAR2 and are capped at 3500 characters to avoid ORA-22835.
-- Review generated notices because text exceeding this limit will be truncated.
